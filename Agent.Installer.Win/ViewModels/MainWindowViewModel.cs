using Nexus.Agent.Installer.Win.Models;
using Nexus.Agent.Installer.Win.Services;
...
namespace Nexus.Agent.Installer.Win.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public ICommand OpenLogsCommand
        {
            get
            {
                ...
                {
                    var logPath = Path.Combine(Path.GetTempPath(), "Nexus_Installer.log");
        ...
        public async Task Init()
        {
            ...
            IsServiceInstalled = ServiceController.GetServices().Any(x => x.ServiceName == "Nexus_Service");
            if (IsServiceMissing)
            {
        ...
        private bool CheckParams()
        {
                ...
                (serverUri.Scheme != Uri.UriSchemeHttp && serverUri.Scheme != Uri.UriSchemeHttps))
            {
                ...
                MessageBoxEx.Show("Server URL must be a valid Uri (e.g. https://app.nexus.one).", "Invalid Server URL", MessageBoxButton.OK, MessageBoxImage.Error);
                return false;
            }
        ...
        private BitmapImage GetBitmapImageIcon(BrandingInfo bi)
        {
            ...
            {
                imageStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Nexus.Agent.Installer.Win.Assets.Nexus_Icon.png");
            }
        ...
        private async Task Install()
        {
            try
            {
                ...
                HeaderMessage = "Installing Nexus...";
                ...
                if (await Installer.Install(ServerUrl, OrganizationID, DeviceGroup, DeviceAlias, DeviceUuid, CreateSupportShortcut))
                {
                    ...
                    StatusMessage = "Nexus has been installed.  You can now close this window.";
                }
                else
                {
                    Progress = 0;
        ...
        private async Task Uninstall()
        {
            try
            {
                ...
                HeaderMessage = "Uninstalling Nexus...";
                ...
                if (await Installer.Uninstall())
                {
                    ...
                    StatusMessage = "Nexus has been uninstalled.  You can now close this window.";
                }
                else
                {
                    Progress = 0;
