...
namespace Server.Installer
{
    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            Console.WriteLine(AppConstants.NexusAscii);
            Console.ForegroundColor = ConsoleColor.Gray;
            Console.WriteLine("(https://nexus.one)");
            Console.WriteLine();
            Console.WriteLine();
            ...
            {
                ConsoleHelper.WriteError("Nexus Server can only be installed on Linux or Windows.");
                return;
            }
            ...
            ConsoleHelper.WriteLine("Thank you for trying Nexus!  This installer will guide you " +
                "through deploying the Nexus server onto this machine.");
            ...
            ConsoleHelper.WriteLine("If using GitHub Actions, you will need to enter a GitHub Personal Access Token, " +
                "which will allow this app to access your fork of the Nexus repo.  You can generate a PAT at " +
            ...
            ConsoleHelper.WriteLine("If you haven't already, please go to the Actions tab in your Nexus repo " +
            ...
            {
                cliParams.InstallDirectory = ConsoleHelper.ReadLine("Which directory should the server files be extracted to (e.g. /var/www/nexus/)?").Trim();
            }
        ...
        {
            ConsoleHelper.WriteLine("Nexus Server Installer", 0, ConsoleColor.Cyan);
            ConsoleHelper.WriteLine("Builds a customized Nexus server using GitHub actions " +
            ...
            ConsoleHelper.WriteLine("\t--github-username, -u    Your GitHub username, where the forked Nexus repo exists.", 1);
            ...
            ConsoleHelper.WriteLine("\t--web-server, -w    Number.  The web server that will be used as a reverse proxy to forward " +
                "requests to the Nexus server.  Select the appropriate option for your operating system and web server.  " +
