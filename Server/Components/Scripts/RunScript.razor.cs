...
using Nexus.Server.Migrations.PostgreSql;
using Nexus.Server.Migrations.Sqlite;
using Nexus.Server.Migrations.SqlServer;
using Nexus.Server.Pages;
...
namespace Nexus.Server.Components.Scripts
{
    [Authorize]
