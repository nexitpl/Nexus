...
namespace Nexus.Server.Data
{
    public class AppDb : IdentityDbContext
    {
        ...
        public new DbSet<NexusUser> Users { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<IdentityUser>().ToTable("NexusUsers");

            builder.Entity<Organization>()
                .HasMany(x => x.Devices)
                .WithOne(x => x.Organization);
            builder.Entity<Organization>()
                .HasMany(x => x.NexusUsers)
                .WithOne(x => x.Organization);
            builder.Entity<Organization>()
            ...
            builder.Entity<NexusUser>()
               .HasOne(x => x.Organization)
               .WithMany(x => x.NexusUsers);
            ...
            builder.Entity<NexusUser>()
                ...
                .HasConversion(
                    ...
                    x => JsonSerializer.Deserialize<NexusUserOptions>(x, (JsonSerializerOptions)null));
            builder.Entity<NexusUser>()
                .HasMany(x => x.SavedScripts)
                .WithOne(x => x.Creator);
            builder.Entity<NexusUser>()
