...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nexus.Shared.Models.BrandingInfo", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Nexus.Shared.Models.SavedScript", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nexus.Shared.Models.ScriptResult", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Nexus.Shared.Models.ScriptRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Nexus.Shared.Models.ScriptSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DeviceGroupScriptSchedule", b =>
                {
                    ...
                    b.HasOne("Nexus.Shared.Models.ScriptSchedule", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DeviceScriptRun", b =>
                {
                    b.HasOne("Nexus.Shared.Models.Device", null)
                        .WithMany()
                        .HasForeignKey("DevicesID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Nexus.Shared.Models.ScriptRun", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Nexus.Shared.Models.Organization", b =>
                {
                    b.HasOne("Nexus.Shared.Models.BrandingInfo", "BrandingInfo")
                        .WithMany()
            ...
            modelBuilder.Entity("Nexus.Shared.Models.SavedScript", b =>
                {
                    b.HasOne("Nexus.Shared.Models.NexusUser", "Creator")
            ...
            modelBuilder.Entity("Nexus.Shared.Models.ScriptResult", b =>
                {
                    ...
                    b.HasOne("Nexus.Shared.Models.ScriptSchedule", "Schedule")
                        .WithMany()
