...
namespace Nexus.Server.Pages
{
    ...
    public partial class ServerConfig : AuthComponentBase
    {
        ...
        private readonly List<NexusUser> _userList = new();
        ...
        private IEnumerable<NexusUser> UserList
        {
            get
            {
        ...
        private async Task SaveAndTestSmtpSettings()
        {
            ...
            var success = await EmailSender.SendEmailAsync(User.Email, "Nexus Test Email", "Congratulations! Your SMTP settings are working!", User.OrganizationID);
            if (success)
            {
        ...
        private void SetIsServerAdmin(ChangeEventArgs ev, NexusUser user)
        {
