...
using Nexus.Desktop.Core.Utilities;
using Nexus.Desktop.Win.Services;
using Nexus.Shared.Models;
using Nexus.Shared.Models.RemoteControlDtos;
using SkiaSharp;
...
namespace Nexus.Tests
{
    ...
    public class ManualTests
    {
        ...
        {
            using var mrs = Assembly.GetExecutingAssembly().GetManifestResourceStream($"Nexus.Desktop.Win.Tests.Resources.{imageFileName}.jpg");
