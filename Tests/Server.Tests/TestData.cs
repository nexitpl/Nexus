...
using Moq;
using Nexus.Server.Areas.Identity.Pages.Account.Manage;
...
namespace Nexus.Tests
{
    public class TestData
    {
        ...
        public NexusUser Admin1 { get; } = new NexusUser()
        {
        ...
        public NexusUser Admin2 { get; private set; } 
        ...
        public NexusUser User1 { get; private set; }

        public NexusUser User2 { get; private set; }
        ...
        private async Task Init()
        {
            ...
            var userManager = IoCActivator.ServiceProvider.GetRequiredService<UserManager<NexusUser>>();
